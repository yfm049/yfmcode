...
public class NoticeActivity extends Activity {
	...
	private int categoryid, channelid, currchannelid,currpage,channeltextSize;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		channeltextSize=this.getResources().getDimensionPixelSize(R.dimen.channelcode_small_size);
		//初始化弹出框
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			if (msg.what == SystemPlayer.surfaceCreated) {
				...
				LogUtils.write("notice", ComUtils.GetString(NoticeActivity.this, R.string.startplay));
				player.play();
				setStatus(false, ComUtils.GetString(NoticeActivity.this, R.string.startplay));
			} else if (msg.what == SystemPlayer.mediaplayererror) {
				setStatus(true, ComUtils.GetString(NoticeActivity.this, R.string.playfail));
			} else if (msg.what == SystemPlayer.mediaplayerbufferedStart) {
				setStatus(true, ComUtils.GetString(NoticeActivity.this, R.string.huanchong));
			} else if (msg.what == SystemPlayer.mediaplayerbufferedEnd) {
				setStatus(false, ComUtils.GetString(NoticeActivity.this, R.string.huanchonged));
			} else if (msg.what == SystemPlayer.mediaplayerserverDied) {
				setStatus(true, ComUtils.GetString(NoticeActivity.this, R.string.linktimeout));
			} else if (msg.what == SystemPlayer.mediaplayerstart) {
				setStatus(false, ComUtils.GetString(NoticeActivity.this, R.string.playback));
				...
				setStatus(true, ComUtils.GetString(NoticeActivity.this, R.string.loading));
	...
	public void fullScreenPlayview() {
		...
		isfullscreen = true;
		channelcode.setTextSize(TypedValue.COMPLEX_UNIT_PX, channeltextSize*2.0f);
	}
	...
	public void minScreenPlayview() {
		...
		fixedpos(channellist);
		channellist.requestFocus();
		channelcode.setTextSize(TypedValue.COMPLEX_UNIT_PX, channeltextSize);
	}
