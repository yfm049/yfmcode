	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			if (msg.what == SystemPlayer.surfaceCreated) {
				...
				player.play();
				setStatus(false, ComUtils.GetString(PlayTVActivity.this, R.string.startplay));
			} else if (msg.what == SystemPlayer.mediaplayererror) {
				setStatus(true, ComUtils.GetString(PlayTVActivity.this, R.string.playfail));
			} else if (msg.what == SystemPlayer.mediaplayerbufferedStart) {
				setStatus(true, ComUtils.GetString(PlayTVActivity.this, R.string.huanchong));
			} else if (msg.what == SystemPlayer.mediaplayerbufferedEnd) {
				setStatus(false, ComUtils.GetString(PlayTVActivity.this, R.string.huanchonged));
			} else if (msg.what == SystemPlayer.mediaplayerserverDied) {
				setStatus(true, ComUtils.GetString(PlayTVActivity.this, R.string.linktimeout));
			} else if (msg.what == SystemPlayer.mediaplayerstart) {
				setStatus(false, ComUtils.GetString(PlayTVActivity.this, R.string.playback));
			} else if (msg.what == ForceTvThread.ForceTvsuc) {
				player.setPlayUrl(msg.obj.toString());
				setStatus(true, ComUtils.GetString(PlayTVActivity.this, R.string.loading));
