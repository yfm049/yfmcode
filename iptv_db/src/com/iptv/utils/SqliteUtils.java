...
public class SqliteUtils extends SQLiteOpenHelper {
	...
	public void savetvdate(SQLiteDatabase db,String tid,String tname,String httpurl,String hotlink,String isflag){
		String iscz="select * from tvdate where tid=?";
		Cursor cursor=db.rawQuery(iscz, new String[]{tid});
		if(!cursor.moveToNext()){
			String sql="insert into tvdate(tid,tname,httpurl,hotlink,isflag) values(?,?,?,?,?)";
			db.execSQL(sql, new Object[]{tid,tname,httpurl,hotlink,isflag});
		}
		cursor.close();
