...
public class SqliteUtils extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String tvsql = "create table tvdate(tid integer,groupid integer,groupname varchar(100),tname varchar(100),httpurl varchar(400),hotlink varchar(100),isflag integer,logo varchar(200),epg varchar(400))";
