...
public class NoticeActivity extends Activity {
	...
	private void playChannel(int pos) {
		...
		player.reset();
		ForceTvUtils.switch_chan(channel.getHttpurl(),channel.getHotlink(),ComUtils.getConfig(this, "name", ""),handler);
		...
		NetUtils.GetNotice(this,channel, handler);
	...
	class OnClickListenerImpl implements OnClickListener, OnItemClickListener,
		...
		public void onItemSelected(AdapterView<?> arg0, View arg1, int pos,
			...
			Channel channel = listcn.get(pos);
			NetUtils.GetNotice(NoticeActivity.this,channel, handler);
		}
