	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			if (msg.what == Player.surfaceCreated) {
				...
				nygadapter.notifyDataSetChanged();
				if(!isfullscreen){
					Toast toast = Toast.makeText(NoticeActivity.this,
							R.string.notice_fail, 500);
				...
				Toast toast = Toast.makeText(NoticeActivity.this,
						R.string.forcetv_fail, Toast.LENGTH_SHORT);
				toast.setGravity(Gravity.BOTTOM | Gravity.CENTER, 0, 0);
				toast.show();
				...
				Toast toast = Toast.makeText(NoticeActivity.this,
						R.string.shoucang_fail, Toast.LENGTH_SHORT);
				toast.setGravity(Gravity.BOTTOM | Gravity.CENTER, 0, 0);
				toast.show();
