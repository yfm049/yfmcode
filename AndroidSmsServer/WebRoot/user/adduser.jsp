		...
		if ($("#adduserform").valid()) {
			...
			$.post($("#adduserform").attr("action"), form, function(msg) {
				if (msg.state == 0) {
					...
					window.open("control/data!UserList.action", "_self");
				}
	...
	<table width="100%" height="99%" border="0" cellpadding="0"
		...
		<tr>
			...
			<td valign="top" bgcolor="#F7F8F9" height="100%">
				<form action="control/data!Adduser.action" id="adduserform">
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						style="margin-top: 5px">
						<tr class="nowtable" height="30">
							<td class="left_txt2" style="padding-left: 15px">添加用户</td>
						</tr>
					</table>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tbody>
							<tr>
								...
								<td class="left_txt2"><input type="text"
									name="mapparam.name" style="width: 30%" class="required" minlength="6"></td>
							</tr>
							<tr>
								<td class="left_txt2" style="text-align: right;">密码：</td>
								<td class="left_txt2"><input type="password"
									name="mapparam.pass" style="width: 30%" class="text required" minlength="6"></td>
							</tr>
							
							<tr>
								<td class="left_txt2" style="text-align: right;">手机号：</td>
								<td class="left_txt2"><input type="text"
									name="mapparam.phonenum" style="width: 30%" class="required" digits="true" minlength="6"></td>
							</tr>
							<tr>
								<td class="left_txt2" style="text-align: right;">imei：</td>
								<td class="left_txt2"><input type="text"
									name="mapparam.imei" style="width: 30%" minlength="10"></td>
							</tr>
							<tr>
