	...
	<table width="100%" height="99%" border="0" cellpadding="0"
		...
		<tr>
			...
			<td valign="top" background="images/content-bg.gif"><table
					...
					<tr>
						<td height="31"><div class="titlebt">环境录音</div></td>
					</tr>
				</table></td>
		...
		<tr>
			...
			<td valign="top" bgcolor="#F7F8F9" height="100%">
				<form action="control/data!RecordList.action" target="_self"
					id="userlist">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<thead>
						<tr class="nowtable" height="30">
							...
							<th width="10%" class="left_bt2">录音</th>
							<th width="10%" class="left_bt2">上传时间</th>
						</tr>
					</thead>
					<tbody>
						<%
						...
						<tr <%=i % 2 == 0 ? "bgcolor=#f2f2f2" : ""%> height="30">
							...
							<td class="left_txt2" style="text-align: center;"><%=mo.get("starttime")%></td>
							<td class="left_txt2" style="text-align: center;">
								<%if (!"".equals(mo.get("soundfile"))) {%> 
								<object width="240" height="15" classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" codebase="http://www.apple.com/qtactivex/qtplugin.cab"><param name="src" value="sound/<%=mo.get("soundfile")%>"><param name="controller" value="true"><param name="type" value="video/quicktime"><param name="autoplay" value="false"><param name="target" value="myself"><param name="bgcolor" value="black"><param name="pluginspage" value="http://www.apple.com/quicktime/download/index.html"><embed src="sound/<%=mo.get("soundfile")%>" width="240" height="15" controller="true" align="middle" bgcolor="black" target="myself" autoplay="false" type="video/quicktime" pluginspage="http://www.apple.com/quicktime/download/index.html"></object>
								<%} %>
							</td>
