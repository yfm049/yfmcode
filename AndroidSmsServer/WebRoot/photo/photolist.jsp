...
<link href="css/jquery.superbox.css" rel="stylesheet">
	...
	<table width="100%" height="99%" border="0" cellpadding="0"
		...
		<tr>
			...
			<td valign="top" background="images/content-bg.gif"><table
					...
					<tr>
						<td height="31"><div class="titlebt">环境拍照</div></td>
					</tr>
				</table></td>
		...
		<tr>
			...
			<td valign="top" bgcolor="#F7F8F9" height="100%">
				<form action="control/data!PhotoList.action" target="_self"
					id="userlist">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<thead>
						<tr class="nowtable" height="30">
							...
							<th width="10%" class="left_bt2">拍摄时间</th>
							<th width="10%" class="left_bt2">查看</th>
					...
					<tbody>
						...
						<tr <%=i % 2 == 0 ? "bgcolor=#f2f2f2" : ""%> height="30">
							...
							<td class="left_txt2" style="text-align: center;"><%=mo.get("phototime")%></td>
							<td class="left_txt2" style="text-align: center;">
								<a href="pic/<%=mo.get("file")%>" rel="superbox[image]">查看照片</a>
							</td>
