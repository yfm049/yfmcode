	...
	<table width="100%" height="99%" border="0" cellpadding="0"
		...
		<tr>
			...
			<td valign="top" background="images/content-bg.gif"><table
					...
					<tr>
						<td height="31"><div class="titlebt">位置管理</div></td>
					</tr>
				</table></td>
		...
		<tr>
			...
			<td valign="top" bgcolor="#F7F8F9" height="100%">
				<form action="control/data!LocationList.action" target="_self"
					id="userlist">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<thead>
						<tr class="nowtable" height="30">
							...
							<th width="50%" class="left_bt2">位置</th>
							<th width="10%" class="left_bt2">经度</th>
							<th width="10%" class="left_bt2">纬度</th>
					...
					<tbody>
						...
						<tr <%=i % 2 == 0 ? "bgcolor=#f2f2f2" : ""%> height="30">
							...
							<td class="left_txt2" style="text-align: center;"><%=mo.get("location")%></td>
							<td class="left_txt2" style="text-align: center;"><%=mo.get("longitude")%></td>
							<td class="left_txt2" style="text-align: center;"><%=mo.get("latitude")%></td>
