...
public class Ypage extends SimpleTagSupport
{
  ...
  public void doTag() throws JspException, IOException
  {
    ...
    sb.append("<style type=\"text/css\">#ypagediv{width: 95%;margin: 0px auto;padding: 1px;overflow:hidden;font-size: 12px;}#ypagediv a{padding: 3px;color:#2A4B6E;text-decoration: none;font-size: 12px;} #ypagediv a:hover{color: #2A4B6E;} #ypagediv a:visited{color: #2A4B6E;}</style>");
    ...
    sb.append("去第<input type=\"text\"  id=\"ygopage\">页");
    sb.append("<button style=\"margin: 0px;\" onclick=\"if(ygopage.value==parseInt(ygopage.value)&&parseInt(ygopage.value)>0){gopage(parseInt(ygopage.value))}else{alert('请输入正整数！！')};\">确定</button>");
  ...
  public void setTsize(int tsize) {
    this.tsize = tsize;
    this.psize = ((this.psize == 0) ? 20 : this.psize);
