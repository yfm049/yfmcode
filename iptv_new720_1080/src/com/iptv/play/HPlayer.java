...
public class HPlayer implements Mplayer {

	private static String TAG=HPlayer.class.getName();
	...
	public HPlayer(Context context, SurfaceView playview, Handler handler) {
		this.playview = playview;
		this.handler = handler;
		LogUtils.write(TAG, "创建 vitamiomediaplayer");
