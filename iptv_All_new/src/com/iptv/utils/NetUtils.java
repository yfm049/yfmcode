...
public class NetUtils {
	...
	public static void Downlogo(Handler handler,String url) {
		if (Environment.getExternalStorageState().equals(
			...
			DownLoadThread dt = new DownLoadThread(url, logo, new LogoDownloadThreadListener(
					handler));
			dt.start();
		}
	}
	...
	public static void appLogoUpdate(Handler handler) {
		LogoUpdateThread thread = new LogoUpdateThread(handler, "logo.xml");
		thread.start();
	}
