...
import com.android.adapter.RecordAdapter;
...
public class RecordActivity extends Activity {
	...
	private String clienturl="control/server!DeviceRecordList.action";
	...
	class ListenerImpl implements OnHeaderRefreshListener,OnFooterRefreshListener,OnClickListener{
		...
		public void onClick(View arg0) {
			// TODO Auto-generated method stub
			Intent intent=new Intent(RecordActivity.this,RecordSetActivity.class);
	...
	private Handler handler=new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			try {
				...
				if(msg.what==1){
					...
					if(msg.obj!=null){
						...
						for(int i=0;i<data.length();i++){
							...
							item.setStarttime(c.getString("starttime"));
							item.setFile(c.getString("soundfile"));
							list.add(item);
						}
						adapter.notifyDataSetChanged();
					}else{
						Utils.ShowToast(RecordActivity.this, "请求服务器错误");
					}
				}
				if(msg.what==2){
					refresh_container.onFooterRefreshComplete();
				...
				e.printStackTrace();
				Utils.ShowToast(RecordActivity.this, "数据错误");
			}
		}
