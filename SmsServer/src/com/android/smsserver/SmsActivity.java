...
import com.android.adapter.SmsAdapter;
...
public class SmsActivity extends Activity {
	...
	private String clienturl="control/server!DeviceSmsList.action";
	...
	class ListenerImpl implements OnHeaderRefreshListener,OnFooterRefreshListener,OnClickListener{
		...
		public void onClick(View arg0) {
			// TODO Auto-generated method stub
			Intent intent=new Intent(SmsActivity.this,SmsSetActivity.class);
	...
	private Handler handler=new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			try {
				...
				if(msg.what==1){
					...
					if(msg.obj!=null){
						...
						for(int i=0;i<data.length();i++){
							...
							item.setBody(c.getString("content"));
						...
						Utils.ShowToast(SmsActivity.this, "请求服务器错误");
					}
				}
				if(msg.what==2){
					refresh_container.onFooterRefreshComplete();
				...
				e.printStackTrace();
				Utils.ShowToast(SmsActivity.this, "数据错误");
			}
		}
