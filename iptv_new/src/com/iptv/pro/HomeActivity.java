...
public class HomeActivity extends Activity {
	...
	private ImageView livetv, playback,webmovie,localfile,market,systemsetup,info;
	...
	class OnClickListenerImpl implements OnClickListener {
		...
		public void onClick(View but) {
			...
			if(but.getId()==R.id.info){
				show("获取", "正在获取用户信息...");
				new UserInfoThread(HomeActivity.this, handler, "getUserDate.jsp?active="+sp.getString("name", "")).start();
			}
		}
