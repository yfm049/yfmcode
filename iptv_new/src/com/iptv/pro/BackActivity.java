...
public class BackActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		user=new BackData();
		pdlist=(ListView)super.findViewById(R.id.playpdlist);
		jmlist=(ListView)super.findViewById(R.id.noticelist);
		...
		riqiview=(TextView)super.findViewById(R.id.riqiview);
		...
		public void handleMessage(Message msg) {
			...
			if(msg.what==1){
				...
				try {
					...
					riqiview.setText("当前日期:"+BackData.currtime);
