...
public class PasswordAsyncTask extends AsyncTask<String, Integer, JSONObject> {

	private progressDialogUtils pdu;
	private Context context;
	private Handler handler;

	public PasswordAsyncTask(Context context, Handler handler) {
	...
	protected JSONObject doInBackground(String... params) {
		...
		nvps.add(new BasicNameValuePair("a", "setPassword"));
		nvps.add(new BasicNameValuePair("userid", params[0]));
