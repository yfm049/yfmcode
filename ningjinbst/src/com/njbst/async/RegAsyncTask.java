...
public class RegAsyncTask extends AsyncTask<String, Integer, JSONObject> {

	private progressDialogUtils pdu;
	private Context context;
	private Handler handler;

	public RegAsyncTask(Context context, Handler handler) {
	...
	protected void onPreExecute() {
		...
		super.onPreExecute();
		pdu.showPd(R.string.reging_msg);
	}
	...
	protected JSONObject doInBackground(String... params) {
		...
		nvps.add(new BasicNameValuePair("a", "reg"));
