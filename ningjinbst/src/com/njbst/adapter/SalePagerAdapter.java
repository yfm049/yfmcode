...
public class SalePagerAdapter extends PagerAdapter {
	...
	private List<SaleInfo> ads;
	
	public SalePagerAdapter(Context context,List<SaleInfo> ads){
	...
	public Object instantiateItem(ViewGroup container, int position) {
		// TODO Auto-generated method stub
		SaleInfo ad=ads.get(position);
		View v=LayoutInflater.from(context).inflate(R.layout.activity_sale_top_item_item, null);
	...
	class ListenerImpl implements OnClickListener{
		...
		private SaleInfo ad;
		public ListenerImpl(SaleInfo ad){
			this.ad=ad;
		}
		@Override
