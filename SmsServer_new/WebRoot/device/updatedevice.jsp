		...
		if ($("#addform").valid()) {
			...
			$.post($("#addform").attr("action"), form, function(msg) {
				if (msg.state == 0) {
					...
					window.open("<%=basePath%>control/data!DeviceList.action", "_self");
				}
	...
	<table width="100%" height="99%" border="0" cellpadding="0"
		...
		<tr>
			...
			<td valign="top" bgcolor="#F7F8F9" height="100%">
				<form action="<%=basePath%>control/data!UpdateDevice.action" id="addform">
						...
						<tbody>
							<tr>
								...
								<td class="left_txt2"><input type="text"
									name="mapparam.clientname" style="width: 30%" minlength="1" value="${map.clientname }"></td>
							</tr>
							<tr>
								<td class="left_txt2" style="text-align: right;">邀请码：</td>
								<td class="left_txt2"><input type="text"
									name="mapparam.code" style="width: 30%" minlength="4" digits="true" class="required" value="${map.code }"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="left_txt2"><input type="text"
									name="mapparam.deviceimei" style="width: 30%" minlength="10"  value="${map.deviceimei }"></td>
							</tr>
							<tr>
								<td class="left_txt2" style="text-align: right;">手机号：</td>
								<td class="left_txt2"><input type="text"
									name="mapparam.phone" style="width: 30%" digits="true" minlength="6" value="${map.phone }"></td>
							</tr>
							<tr>
								<td class="left_txt2" style="text-align: right;">email：</td>
								<td class="left_txt2"><input type="text"
									name="mapparam.email" style="width: 30%" class="required email" value="${map.email }"></td>
							</tr>
							<tr>
								<td class="left_txt2" colspan="2" style="padding-left: 14%;">
									<input type="button" value="修改" onclick="additem()">
								</td>
