...
public class LoginActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		loginview=(LinearLayout)this.findViewById(R.id.loginview);
		...
		NetUtils.showDialog(pd, ComUtils.getrestext(LoginActivity.this, R.string.login_title), ComUtils.getrestext(LoginActivity.this, R.string.login_mac));
		NetUtils.macThread(this, handler);
	...
	private Handler handler=new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			}else if(msg.what==LoginMacThread.loginmacsuc){
				mac.setText(msg.obj.toString());
				if(isautologin()){
