...
public class LoginActivity extends Activity {
	...
	private Button loginbut,zhuxiao,huifu,test;
	...
	private void test(){
		show();
		loginthread = new LoginThread(this,handler, "free.html");
		loginthread.start();
	}
	...
	public void huifu(View v){
		...
		if (file != null) {
			showhuifudialog();
			DownLoadThread dt = new DownLoadThread("http://dl.seasoniptv.com:8080/ptvplus.apk", file,
