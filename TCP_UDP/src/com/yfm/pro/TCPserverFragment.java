...
public class TCPserverFragment extends BaseActivity {
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			if(msg.what==6){
				Toast.makeText(TCPserverFragment.this, "服务启动异常，端口被占用",
						Toast.LENGTH_SHORT).show();
				mimg.setImageResource(R.drawable.serveroff);
			}
			if(msg.what==7){
				Toast.makeText(TCPserverFragment.this, "服务已关闭",
						Toast.LENGTH_SHORT).show();
				mimg.setImageResource(R.drawable.serveroff);
			}
		}
		...
		public void onClick(View v) {
			...
			if (v.getId() == R.id.sendbut) {
				...
				if (cs != null) {
					...
					Toast.makeText(TCPserverFragment.this, "未选中连接", Toast.LENGTH_SHORT).show();
				}
