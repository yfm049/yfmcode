...
public class UdpserverAdapter extends BaseAdapter {

	private List<UdpConnectServer> lc;
	private int cid=0;
	...
	public UdpserverAdapter(Context context,List<UdpConnectServer> lc){
		this.context=context;
		this.lc=lc;
	}
	public UdpConnectServer getserver(){
	...
	public View getView(int arg0, View view, ViewGroup arg2) {
		// TODO Auto-generated method stub
		UdpConnectServer  con=lc.get(arg0);
		if(view==null){
