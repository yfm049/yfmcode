...
public class TcpclientAdapter extends BaseAdapter {

	private List<TcpConnectClient> lc;
	private int cid=0;
	...
	public TcpclientAdapter(Context context,List<TcpConnectClient> lc){
		this.context=context;
		this.lc=lc;
	}
	public TcpConnectClient getclient(){
	...
	public View getView(int arg0, View view, ViewGroup arg2) {
		// TODO Auto-generated method stub
		TcpConnectClient  con=lc.get(arg0);
		if(view==null){
